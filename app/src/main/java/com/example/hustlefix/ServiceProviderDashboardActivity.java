...
public class ServiceProviderDashboardActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    private static final String TAG = "ServiceProviderDash";
    ...
    private void updateNavHeader() {
        if (navigationView != null && navigationView.getHeaderView(0) != null) {
            ...
            if (currentUser != null) {
                ...
                if (ivNavAvatar != null) {
                    ivNavAvatar.setImageResource(R.drawable.ic_avatar_service_provider);
                }
            }
        }
    }
        ...
        bookingsRef.orderByChild("serviceProviderId").equalTo(currentUserId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (tvRating != null) {
                            if (ratingCount > 0) {
                                tvRating.setText(String.format("%.1f Star", totalRating / ratingCount));
                            } else {
                                tvRating.setText("0.0 Star");
                            }
                        }
                    }
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        bookingAdapter = new BookingAdapter(reversed, booking -> {
                            Intent intent = new Intent(ServiceProviderDashboardActivity.this, BookingDetailActivity.class);
